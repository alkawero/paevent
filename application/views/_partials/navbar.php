<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="">Pahoa Event</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="<?=base_url();?>Welcome/speaker" class="nav-link">Pembicara</a></li>
	          <li class="nav-item"><a href="<?=base_url();?>Welcome/agenda" class="nav-link">Agenda</a></li>
